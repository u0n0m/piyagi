...
public class AlyacEveningSettingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //저장 버튼 클릭
        Button btn_save = (Button) findViewById(R.id.alyac_evening_save);
        ...
        //오전/오후 변경 위쪽 버튼
        ImageButton btn_alyac_evening_ampm_up = (ImageButton) findViewById(R.id.btn_alyac_evening_ampm_up);
        btn_alyac_evening_ampm_up.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TextView tv = (TextView) findViewById(R.id.textview_alyac_evening_ampm);
                if(alyac_ampm == true ) {
                    alyac_ampm = false;
                    tv.setText("오후");
                }
        ...
        //오전/오후 변경 아래쪽 버튼
        ImageButton btn_alyac_evening_ampm_down = (ImageButton) findViewById(R.id.btn_alyac_evening_ampm_down);
        btn_alyac_evening_ampm_down.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TextView tv = (TextView) findViewById(R.id.textview_alyac_evening_ampm);
                if(alyac_ampm == true ) {
        ...
        //시간 올리기 버튼(1시간 단위로)
        ImageButton btn_alyac_evening_hour_up = (ImageButton) findViewById(R.id.btn_alyac_evening_hour_up);
        btn_alyac_evening_hour_up.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TextView tv = (TextView) findViewById(R.id.textview_alyac_evening_hour);
                if(alyac_hour == 12 ) {
                    alyac_hour = 0;
                }
                else{
        ...
        //시간 내리기 버튼(1시간 단위로)
        ImageButton btn_alyac_evening_hour_down = (ImageButton) findViewById(R.id.btn_alyac_evening_hour_down);
        btn_alyac_evening_hour_down.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TextView tv = (TextView) findViewById(R.id.textview_alyac_evening_hour);
                if(alyac_hour == 0 ) {
        ...
        //분 올리기 버튼(10분 단위로)
        ImageButton btn_alyac_evening_minute_up = (ImageButton) findViewById(R.id.btn_alyac_evening_minute_up);
        btn_alyac_evening_minute_up.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        //분 내리기 버튼(10분 단위로)
        ImageButton btn_alyac_evening_minute_down = (ImageButton) findViewById(R.id.btn_alyac_evening_minute_down);
        btn_alyac_evening_minute_down.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                TextView tv = (TextView) findViewById(R.id.textview_alyac_evening_minute);
                if(alyac_minute <= 0 ) {
    ...
    public boolean save_alyac_evening_settings(){ // 저장버튼 누르면 실행되는 내용
        ...
        editor.putString("evening_ampm",ampm); //아침약 알람 설정 저장
        editor.putString("evening_hour",hour); //아침약 알람 설정 저장
