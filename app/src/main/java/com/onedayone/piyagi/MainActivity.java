...
public class MainActivity extends AppCompatActivity {
    ...
    public void displayMain(){
        ...
        //알약 점심 복용 메뉴 표시
        ampm_setting = pref_alyac.getString("day_ampm", "오후");
        hour_setting = pref_alyac.getString("day_hour", "01");
        minute_setting = pref_alyac.getString("day_minute", "00");
        ...
        ampm_setting = pref_alyac.getString("evening_ampm", "오후");
        hour_setting = pref_alyac.getString("evening_hour", "07");
        minute_setting = pref_alyac.getString("evening_minute", "10");
        ...
        //알약 취침전 복용 메뉴 표시
        pref_alyac = getApplicationContext().getSharedPreferences("AlyacSettings", Context.MODE_PRIVATE);
        ampm_setting = pref_alyac.getString("night_ampm", "오후");
        hour_setting = pref_alyac.getString("night_hour", "10");
        minute_setting = pref_alyac.getString("night_minute", "40");
        ...
        String hospital_settings1 = month_setting + "월 " + day_setting + "일 " + ampm_setting + " " + hour_setting + ":" + minute_setting;
